        ...
        <div className="relative container mx-auto py-12">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-3">
              <Button variant="outline" size="sm" className="bg-white/80 backdrop-blur border-slate-200 hover:bg-white">
          ...
          {bookingsList.length > 0 && (
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-8">
              <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-blue-50 to-blue-100/50 backdrop-blur-sm">
                <div className="absolute top-0 right-0 w-20 h-20 bg-blue-200/30 rounded-full -translate-y-4 translate-x-4"></div>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-blue-700 text-sm font-medium">Total {isAdmin ? 'Bookings' : 'Orders'}</p>
                      <p className="text-3xl font-bold text-blue-900 mt-1">{bookingsList.length}</p>
                    </div>
              ...
              <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-green-50 to-emerald-100/50 backdrop-blur-sm">
                <div className="absolute top-0 right-0 w-20 h-20 bg-green-200/30 rounded-full -translate-y-4 translate-x-4"></div>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-green-700 text-sm font-medium">Completed</p>
                      <p className="text-3xl font-bold text-green-900 mt-1">{completedBookings}</p>
                    </div>
              ...
              <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-amber-50 to-yellow-100/50 backdrop-blur-sm">
                <div className="absolute top-0 right-0 w-20 h-20 bg-amber-200/30 rounded-full -translate-y-4 translate-x-4"></div>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-amber-700 text-sm font-medium">Total {isAdmin ? 'Revenue' : 'Spent'}</p>
                      <p className="text-2xl font-bold text-amber-900 mt-1">{formatPrice(totalRevenue)}</p>
                    </div>
              ...
              {averageRating > 0 && (
                <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-purple-50 to-violet-100/50 backdrop-blur-sm">
                  <div className="absolute top-0 right-0 w-20 h-20 bg-purple-200/30 rounded-full -translate-y-4 translate-x-4"></div>
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-purple-700 text-sm font-medium">Avg Rating</p>
            ...
            {bookingsList.length === 0 ? (
              <div className="py-24 text-center">
                <div className="relative mb-8">
                  ...
                  <Calendar className="relative mx-auto h-16 w-16 text-slate-400" />
                </div>
                ...
                {!isAdmin && (
                  <Button 
                    className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-8 py-3 text-lg shadow-lg hover:shadow-xl transition-all duration-300"
                    ...
                    <TableBody className="bg-white divide-y divide-slate-100">
                      {bookingsList.map((booking, index) => (
                        <TableRow key={booking.id} className="hover:bg-slate-50/50 transition-colors duration-200 group">
                            ...
                            <TableCell className="px-6 py-6 whitespace-nowrap">
                              <div className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col">
                                  <span className="font-medium text-slate-900">{booking.customer.name || "N/A"}</span>
                                  <span className="text-sm text-slate-500">{booking.customer.email || "N/A"}</span>
                                </div>
                              </div>
                            </TableCell>
                          )}
                          ...
                          <TableCell className="px-6 py-6 whitespace-nowrap">
                            <div className="flex items-center gap-4">
                              <div className="relative w-14 h-14 rounded-xl overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200 flex-shrink-0 shadow-sm">
                              ...
                              <div className="flex flex-col">
                                <span className="font-semibold text-slate-900 text-base">{booking.service.name}</span>
                          ...
                          <TableCell className="px-6 py-6 whitespace-nowrap">
                            <div className="flex items-center gap-3">
                              <Badge
                                className={cn(
                                  "inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold border-0 shadow-sm",
                                  {
                          ...
                          <TableCell className="px-6 py-6 whitespace-nowrap text-right">
                            <Dialog>
                              <DropdownMenu>
                              ...
                              {/* KEEPING YOUR DIALOG EXACTLY AS IT IS */}
